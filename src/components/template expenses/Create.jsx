...
const Create = ({element})=>{
  ...
  const handleSubmit = (e) => {
   ...
   Axios.post(`http://localhost:8080/${element}`, {amount:amount,description:description,categoryId:categoryId,methodId:methodId},{
    headers: {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <select class="form-select form-select-lg mb-3" aria-label="Large select example" id="category" name="category" value={categoryId}
        ...
        <select class="form-select form-select-lg mb-3" aria-label="Large select example" id="category" name="method" value={methodId}
