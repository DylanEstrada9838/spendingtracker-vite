        ...
        <Toolbar disableGutters>
            ...
            >
              {pages.map((page) => (
                  ...
                  <Link to={`/${links[pages.indexOf(page)]}`}>
                    <Typography style={{color:'black'}} textAlign="center" className='nav-expanded'>{page}</Typography>
                  </Link>
                  </MenuItem>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              ...
              >
                <Link style={{color:'white'}} to={`/${links[pages.indexOf(page)]}`}>
                  {page}
                </Link>
              </Button>
            ))}
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={handleCloseUserMenu}>
                  <Typography textAlign="center" className='nav'>{setting}</Typography>
                </MenuItem>
              ))}
            </Menu>
          </Box>
